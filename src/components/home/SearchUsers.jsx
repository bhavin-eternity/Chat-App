...
function SearchUsers({ onSelectUser, onClose }) {
    ...
    return (
        <div className="flex felx-col h-full bg-slate-950">
            <div className="felx items-center gap-3 px-4 py-3 border-b border-slate-800">
